...
export function CopyLinkButton({ className = "" }: { className?: string }) {
  ...
  return (
    <motion.button
      ...
      onClick={copy}
      whileTap={tap}
      className={`inline-flex items-center gap-1.5 rounded-lg border border-line px-3 py-2 text-sm font-medium text-ink-soft transition-colors hover:border-ink-soft hover:text-accent ${className}`}
    >
